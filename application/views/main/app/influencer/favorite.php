 ...
 */
$data['_this'] = array(
	'page-class' => 'influencer-favorite',
	'page-js' => array(
		'main/js/app/influencer/favorite.js',
	)
);
?>
						...
						<table class="table table-bordered table-striped mg-t favorite-datatable" data-url="">
							...
							<?php foreach ($data['favorites'] as $a): ?>
								<tr>
									...
									<td data-search="">
										<button class="btn btn-danger x-brand-unfavorite" title="Unfavorite" data-url=<?=$Url::base('brand/favorite')?> data-id="<?=$a['_id']?>"><i class="fa fa-star"></i></button>
									</td>
								</tr>
							<?php endforeach; ?>
							</tbody>
