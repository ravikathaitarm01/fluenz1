...
<head>
	...
	<title>Fluenz - Access Denied</title>
...
<div class="center-wrapper">
	...
	<div class="center-content text-center">
		<div class="error-number animated rubberBand"><i class="ti-lock mr15 show"></i>403</div>
		<div class="mb25">INSUFFICIENT PERMISSIONS</div>
		<p>Sorry, but you are not allowed to view this section</p>
		<div class="row mt25">
			<a href="<?=$data['_meta']['back-url']?>"><i class="fa fa-arrow-circle-left"></i> Back</a>
		</div>
		<!-- Error -->
